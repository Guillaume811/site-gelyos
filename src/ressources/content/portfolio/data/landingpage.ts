...
export const landingpageProjects: Project[] = [
  ...
  },
  {
    ...
    client: 'Zoza Pizza',
    title: 'Landing page mobile-first pour une pizzeria marseillaise',
    shortDescription:
      "Landing page mobile-first réalisée pour Zozà Pizza, pizzeria marseillaise située dans le 5e arrondissement, afin de présenter sa carte, son savoir-faire artisanal et permettre aux clients de commander rapidement par téléphone.",
    category: 'landingpage',
    description:
      "Ce projet est une landing page réalisée pour Zozà Pizza, une pizzeria située à Marseille, pensée avant tout pour une consultation rapide sur mobile.\n\nL’objectif du site est de présenter l’identité de l’établissement, sa carte et son univers mêlant l’âme de Marseille à l’inspiration napolitaine. La page met en avant les pizzas, les produits italiens et français soigneusement sélectionnés, le savoir-faire artisanal ainsi que les informations essentielles comme les horaires, l’adresse et les zones de livraison.\n\nL’expérience a été conçue pour aller droit au but : découvrir la carte facilement, rassurer les visiteurs grâce aux avis clients et permettre une commande simple et immédiate par téléphone.",
    accordionItems: [
      {
        id: 'technologies',
        title: 'Technologies utilisées',
      ...
      },
      {
        ...
        title: 'Fonctionnalités clés',
        description: [
          { type: 'text', text: 'Présentation claire et attrayante de la carte.' },
          { type: 'lineBreak' },
          { type: 'lineBreak' },
          { type: 'text', text: 'Scroll Snap' },
          { type: 'lineBreak' },
          { type: 'lineBreak' },
          { type: 'text', text: 'Navigation intuitive et expérience utilisateur optimale.' },
        ],
      },
    ],
    url: 'https://zozapizza.fr/',
    carousel: [
      {
        id: '01',
        src: '/pictures/portfolio/landingpage/zozaPizza/carousel/hero-section.webp',
        title: 'Hero section',
        alt: 'Hero section',
      },
      {
        id: '02',
        src: '/pictures/portfolio/landingpage/zozaPizza/carousel/presentation-pizzeria.webp',
        title: 'Presentation pizzeria',
        alt: 'Presentation pizzeria',
      },
      {
        id: '03',
        src: '/pictures/portfolio/landingpage/zozaPizza/carousel/pizza-du-moment.webp',
        title: 'Pizza du moment',
        alt: 'Pizza du moment',
      },
      {
        id: '04',
        src: '/pictures/portfolio/landingpage/zozaPizza/carousel/la-carte.webp',
        title: 'La carte',
        alt: 'La carte',
      },
      {
        id: '05',
        src: '/pictures/portfolio/landingpage/zozaPizza/carousel/les-avis-clients.webp',
        title: 'Les avis clients',
        alt: 'Les avis clients',
      },
    ],
  },
]
