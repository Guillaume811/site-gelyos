...
import iconWeb from '@/assets/icons/iconWeb.png'
import iconApp from '@/assets/icons/iconApp.png'
import iconMaintenance from '@/assets/icons/iconMaintenance.png'
import iconSeo from '@/assets/icons/iconSeo.png'
    ...
    cards: [
        {
           ...
           description: 'Du **site vitrine sur mesure** au **site e-commerce personnalisé**, je vous développe des solutions uniques, modernes et évolutives, adaptées à vos objectifs et à votre image de marque.',
        ...
        },
        {
           ...
           description: 'Je vous conçois des **applications web sur mesure** performantes et sécurisées, pensées pour répondre à vos besoins spécifiques et améliorer vos processus métiers.',
           secondButton: { label: 'Découvrir', to: '/services' }
        },
        {
           id: 'maintenance',
           ...
           description: 'Un site doit rester rapide, sécurisé et à jour. Je vous propose la **maintenance de site internet** et un **support technique continu** pour assurer la fiabilité et l\'évolution de vos projets web.',
           secondButton: { label: 'Découvrir', to: '/services' }
        },
        {
           id: 'seo',
